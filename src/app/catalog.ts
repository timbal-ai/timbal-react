...
const PRIMITIVES: CatalogEntry[] = [
  // Layout
  {
    ...
    kind: "primitive",
    category: "Layout",
    description: "Sidebar and/or topbar + main layout shell (topbar slot = horizontal nav / brand + search + account). Layout-only (the copilot is separate).",
  ...
  },
  {
    ...
    kind: "primitive",
    category: "Layout",
    description: "Collapsible product nav rail with auto mobile drawer (syncs to AppShell). variant=\"flush\" full-height rail by default; \"floating\" for the rounded studio card.",
